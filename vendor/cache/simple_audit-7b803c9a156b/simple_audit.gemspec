...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "LICENSE", "README.markdown", "Rakefile", "TODO", "generators/simple_audit_migration/USAGE", "generators/simple_audit_migration/simple_audit_migration_generator.rb", "generators/simple_audit_migration/templates/migration.rb", "lib/generators/simple_audit/migration/migration_generator.rb", "lib/generators/simple_audit/migration/templates/active_record/migration.rb", "lib/simple_audit.rb", "lib/simple_audit/audit.rb", "lib/simple_audit/helper.rb", "lib/simple_audit/simple_audit.rb", "rails-magazine-article.markdown", "rails/init.rb", "screenshot.png", "simple_audit.gemspec", "test/fixtures/addresses.yml", "test/fixtures/people.yml", "test/test_helper.rb", "test/unit/simple_audit_test.rb", "test/fixtures", "test/unit"]
