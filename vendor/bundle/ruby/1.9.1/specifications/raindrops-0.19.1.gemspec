...
Gem::Specification.new do |s|
  ...
  s.email = "raindrops-public@yhbt.net"
  ...
  s.files = ["README", "LICENSE", "NEWS", "ext/raindrops/raindrops.c", "ext/raindrops/linux_inet_diag.c", "ext/raindrops/tcp_info.c", "ext/raindrops/extconf.rb"]
