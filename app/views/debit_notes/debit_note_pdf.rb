...
class DebitNotePdf < Prawn::Document
  ...
  #Dynamic Content
  def draw_header
    text_box @debit_note.account.name1, at: [10.mm, 113.mm], size: 12, width: 100.mm, height: 20.mm, style: :bold
    ...
    draw_text @view.docnolize(@debit_note.account.id), at: [150.mm, 112.mm], size: 10, style: :bold
    draw_text @debit_note.doc_date, at: [150.mm, 103.mm], style: :bold
    draw_text @view.docnolize(@debit_note.id), at: [150.mm, 94.5.mm], size: 15, style: :bold
  end
