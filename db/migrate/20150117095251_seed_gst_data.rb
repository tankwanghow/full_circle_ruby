class SeedGstData < ActiveRecord::Migration
  def up    
    # need more work
    assets = Account.where(name1: 'Current Assets')
    liability = Account.where(name1: 'Current Liability')
    expenses = Account.where(name1: 'Administrative And Operating Expenses')
    
    gst_rec = AccountType.create! parent_id: assets.id, name: 'GST Receivables', normal_balance: 'Debit', admin_lock: true, bf_balance: false
    gst_pay = AccountType.create! parent_id: liability.id, name: 'GST Payables', normal_balance: 'Credit', admin_lock: true, bf_balance: false

    Account.create! name1: 'GST Input', account_type_id: gst_rec.id, admin_lock: true, status: 'Active'
    Account.create! name1: 'GST Output', account_type_id: gst_pay.id, admin_lock: true, status: 'Active'
    Account.create! name1: 'GST Controll', admin_lock: true, status: 'Active'
    Account.create! name1: 'GST Liability', account_type_id: cash_or_eq.id, admin_lock: true, status: 'Active'
    Account.create! name1: 'GST Claimable', account_type_id: cash_or_eq.id, admin_lock: true, status: 'Active'
    Account.create! name1: 'GST Suspend', account_type_id: cash_or_eq.id, admin_lock: true, status: 'Active'
    Account.create! name1: 'GST Expense', account_type_id: expenses.id, admin_lock: true, status: 'Active'

    TaxCode.create! tax_type: 'GST for Purchase', code: 'TX', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'IM', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'IS', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'BL', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'NR', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'ZP', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'EP', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'OP', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'TX-E43', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'TX-N43', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'TX-RE', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
                    description: 'This is only applicable to GST registered trader that makes both taxable and exempt supplies (or commonly known as partially exempt trader). This refers to GST incurred that is not directly attributable to the making of taxable or exempt supplies (or commonly known as residual input tax). Example includes operation over-head for a development of mixed property (properties comprise of residential & commercial).'
    TaxCode.create! tax_type: 'GST for Purchase', code: 'GP', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
                    description: 'Purchase within GST group registration, purchase made within a Warehouse Scheme etc.'
    TaxCode.create! tax_type: 'GST for Purchase', code: 'AJP', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
                    description: 'Any adjustment made to Input Tax such as bad debt relief & other input tax adjustments.'

    TaxCode.create! tax_type: 'GST for Supply', code: 'SR', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ZRL', rate: 0,db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ZRE', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ES43', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'DS', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'OS', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ES', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'RS', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
                    description: 'This refers to supplies which are supply given relief from GST.'
    TaxCode.create! tax_type: 'GST for Supply', code: 'GS', rate: 0, db_cr: XXXXXX, gst_account_id: XXXXX,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'AJS', rate: 0.06, db_cr: XXXXXX, gst_account_id: XXXXX,
