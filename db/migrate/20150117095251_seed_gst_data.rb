class SeedGstData < ActiveRecord::Migration
  def up    
    ...
    tx = TaxCode.create! tax_type: 'GST for Purchase', code: 'TX', rate: 0.06, db_cr: 'debit', gst_account_id: gst_input.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'IM', rate: 0.06, db_cr: 'debit', gst_account_id: gst_suspen.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'IS', rate: 0, db_cr: 'debit', gst_account_id: gst_suspen.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'BL', rate: 0.06, db_cr: 'debit', gst_account_id: gst_expens.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'NR', rate: 0, db_cr: 'debit', gst_account_id: gst_expens.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'ZP', rate: 0, db_cr: 'debit', gst_account_id: gst_input.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'EP', rate: 0, db_cr: 'debit', gst_account_id: gst_input.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'OP', rate: 0, db_cr: 'debit', gst_account_id: gst_input.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'TX-E43', rate: 0.06, db_cr: 'debit', gst_account_id: gst_input.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'TX-N43', rate: 0.06, db_cr: 'debit', gst_account_id: gst_input.id,
    ...
    TaxCode.create! tax_type: 'GST for Purchase', code: 'TX-RE', rate: 0.06, db_cr: 'debit', gst_account_id: gst_input.id,
                    description: 'This is only applicable to GST registered trader that makes both taxable and exempt supplies (or commonly known as partially exempt trader). This refers to GST incurred that is not directly attributable to the making of taxable or exempt supplies (or commonly known as residual input tax). Example includes operation over-head for a development of mixed property (properties comprise of residential & commercial).'
    TaxCode.create! tax_type: 'GST for Purchase', code: 'GP', rate: 0, db_cr: 'debit', gst_account_id: gst_input.id,
                    description: 'Purchase within GST group registration, purchase made within a Warehouse Scheme etc.'
    TaxCode.create! tax_type: 'GST for Purchase', code: 'AJP', rate: 0.06, db_cr: 'debit', gst_account_id: gst_claim.id,
                    description: 'Any adjustment made to Input Tax such as bad debt relief & other input tax adjustments.'

    sr = TaxCode.create! tax_type: 'GST for Supply', code: 'SR', rate: 0.06, db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ZRL', rate: 0,db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ZRE', rate: 0, db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ES43', rate: 0, db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'DS', rate: 0.06, db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'OS', rate: 0, db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'ES', rate: 0, db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'RS', rate: 0, db_cr: 'credit', gst_account_id: gst_output.id,
                    description: 'This refers to supplies which are supply given relief from GST.'
    TaxCode.create! tax_type: 'GST for Supply', code: 'GS', rate: 0, db_cr: 'credit', gst_account_id: gst_output.id,
    ...
    TaxCode.create! tax_type: 'GST for Supply', code: 'AJS', rate: 0.06, db_cr: 'credit', gst_account_id: gst_liabi.id,
    ...
    ParticularType.update_all supply_tax_code_id: sr.id, purchase_tax_code_id: tx.id
